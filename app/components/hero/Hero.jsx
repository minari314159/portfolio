	...
	return (
		<div className=" w-full sm:w-[80%] md:w-[90%] lg:w-[70%] h-full flex flex-col items-center justify-center px-10 overflow-hidden">
			<motion.div
				...
				<motion.div className="h-full w-full flex flex-col justify-center items-start gap-5 md:gap-10 ">
					<motion.h2
						variants={textVariant}
						className="font-['Tahoma'] text-6xl sm:text-7xl lg:text-8xl ">
						Bio-Designer & <br />
						Data Scientist
					</motion.h2>
					<motion.h1
						variants={textVariant}
						className=" text-md  md:text-lg lg:text-xl font-lighttracking-wider text-textmain w-[75%]">
						<i>
				...
				<motion.div className="flex w-full  justify-start gap-5 my-5 text-md text-textmain sm:text-lg z-[10]">
					<Link
						href="/portfolio"
